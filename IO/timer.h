...
// These all do the same thing in Windows with float precision
extern fix timer_get_fixed_seconds();
extern fix timer_get_fixed_secondsX();
extern fix timer_get_approx_seconds();

// Miliseconds, used to steady the game
