...
- (id)initWithCoder:(NSCoder *)aDecoder {
	...
	// Movement
	accelerateRect = CGRectMake(120, 130, 55, 55);
	reverseRect = CGRectMake(120, 20, 55, 55);
	slideLeftRect = CGRectMake(65, 75, 55, 55);
	slideRightRect = CGRectMake(175, 75, 55, 55);
	slideUpRect = CGRectMake(25, 105, 35, 80);
	slideDownRect = CGRectMake(25, 20, 35, 80);
	bankLeftRect = CGRectMake(65, 190, 80, 35);
	bankRightRect = CGRectMake(150, 190, 80, 35);
	
	// Combined movement
	accelerateSlideLeftRect = CGRectMake(65, 130, 55, 55);
	accelerateSlideRightRect = CGRectMake(175, 130, 55, 55);
	reverseSlideLeftRect = CGRectMake(65, 20, 55, 55);
	reverseSlideRightRect = CGRectMake(175, 20, 55, 55);
	
	// Weapons
	firePrimaryRect = CGRectMake(460, 100, 70, 70);
	fireSecondaryRect = CGRectMake(380, 20, 70, 70);
	fireFlareRect = CGRectMake(470, 30, 50, 50);
	togglePrimaryRect = CGRectMake(460, 185, 70, 40);
	toggleSecondaryRect = CGRectMake(325, 20, 40, 70);
	
	// Menus
	menuRect = CGRectMake(25, 275, 25, 25);
	mapRect = CGRectMake(515, 275, 25, 25);
	toggleCockpitRect = CGRectMake(185, 275, 25, 25);
	rearViewRect = CGRectMake(345, 275, 25, 25);
