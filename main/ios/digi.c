...
typedef struct sound_object {
	...
	ALuint		handle;			// What handle this sound is playing on.  Valid only if SOF_PLAYING is set.
...
ALuint digi_start_sound(_SOS_START_SAMPLE * sampledata, short soundnum) {
